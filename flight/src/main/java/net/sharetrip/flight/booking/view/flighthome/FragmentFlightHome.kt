...
import net.sharetrip.flight.utils.tripCoinVisibility
import net.sharetrip.flight.shared.view.BaseFragment
//import net.sharetrip.flight.utils.ConfigUtil
...
class FragmentFlightHome : BaseFragment<FlightHomeBinding>() {
    ...
    override fun onStart() {
        ...
        //if (ConfigUtil().showToolbarTripCoin) {
            tripCoinVisibility(true)
        //} else tripCoinVisibility(false)
    ...
    private fun handleDeepLink() {
        ...
        if (uri != null && !isDeepLinkHandled) {
            try {
                ...
                Toast.makeText(
                    requireContext(),
                    "Invalid Search Input! Try filling all fields",
                    Toast.LENGTH_SHORT
                ).show()
            }
