...
import net.sharetrip.flight.booking.model.repository.localdatasource.EMAIL_ADDRESS_IS_NOT_VALID
import net.sharetrip.flight.booking.model.repository.localdatasource.PHONE_NUMBER_IS_EMPTY
