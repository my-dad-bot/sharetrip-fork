...
import net.sharetrip.flight.profile.view.content.ContentFragment.Companion.ENTER_PASSPORT_EXPIRY_DATE
import net.sharetrip.flight.profile.view.content.ContentFragment.Companion.ENTER_PASSPORT_NUMBER
