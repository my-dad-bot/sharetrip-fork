...
import net.sharetrip.flight.databinding.LayoutFilterBottomSheetFlightBinding
import net.sharetrip.flight.utils.ShearedViewModel

class FilterBottomSheet : BottomSheetDialogFragment() {
    private lateinit var bindingView: LayoutFilterBottomSheetFlightBinding
    ...
    private fun layoutId() = R.layout.layout_filter_bottom_sheet_flight
