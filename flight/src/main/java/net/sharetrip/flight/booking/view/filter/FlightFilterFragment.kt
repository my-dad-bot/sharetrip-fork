...
class FlightFilterFragment : BaseFragment<FragmentFlightFilterBinding>() {
    ...
    companion object {
        @JvmField val ARG_FLIGHT_FILTER_INFO_STRING_MODEL = "ARG_FLIGHT_FILTER_INFO_STRING_MODEL"
        @JvmField val ARG_FLIGHT_FILTER_INFO_STRING_FLIGHT_COUNT =
            "ARG_FLIGHT_FILTER_INFO_STRING_FLIGHT_COUNT"
        @JvmField val ARG_FLIGHT_FILTER_BUNDLE = "ARG_FLIGHT_FILTER_BUNDLE"
    }
}
