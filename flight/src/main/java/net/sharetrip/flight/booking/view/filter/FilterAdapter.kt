...
import net.sharetrip.flight.databinding.ItemFiltersFlightBinding
import net.sharetrip.flight.databinding.ItemPriceRangeFlightBinding
...
class FilterAdapter(private val dataList: List<*>, private val viewModel: ShearedViewModel) :
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): RecyclerView.ViewHolder {
        ...
        viewHolder = when (viewType) {
            PRICE -> {
                val binding = DataBindingUtil.inflate<ItemPriceRangeFlightBinding>(
                    inflater,
                    R.layout.item_price_range_flight,
                    parent,
                    false
                )
            ...
            TIME -> {
                ...
                val binding = DataBindingUtil.inflate<ItemFiltersFlightBinding>(
                    inflater,
                    R.layout.item_filters_flight,
                    parent,
                    false
                )
    ...
    inner class StopViewHolder internal constructor(val mBinding: ItemFiltersFlightBinding) :
        RecyclerView.ViewHolder(mBinding.root)

    inner class PriceViewHolder internal constructor(val mBinding: ItemPriceRangeFlightBinding) :
        RecyclerView.ViewHolder(mBinding.root)
