...
class RoundTripViewModel : BaseOperationalViewModel() {
    ...
    val trackerAvailability = true //ConfigUtil().isTrackerAvailable
    ...
    fun handleFromAddress(mData: Intent) {
        val mCode = mData.getStringExtra(ARG_AIRPORT_CODE)
        val mCity = mData.getStringExtra(ARG_AIRPORT_CITY)
        val mAddress = mData.getStringExtra(ARG_AIRPORT_ADDRESS)
