...
import net.sharetrip.flight.databinding.FragmentSingleCalendarFlightBinding
...
internal class SingleDateCalendarFragment : BaseFragment<FragmentSingleCalendarFlightBinding>() {
    ...
    override fun layoutId(): Int = R.layout.fragment_single_calendar_flight
