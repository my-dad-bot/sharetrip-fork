...
import net.sharetrip.flight.utils.ARA_ITEM_FLIGHTS_SEGMENT
import net.sharetrip.flight.utils.ARA_ITEM_FLIGHTS_SEGMENT_DATA
import net.sharetrip.flight.utils.ARA_ITEM_FLIGHTS_SEGMENT_POSITION
import net.sharetrip.flight.utils.ARG_COUPON_RESPONSE
import net.sharetrip.flight.utils.ARG_DISCOUNT_MODEL
import net.sharetrip.flight.utils.ARG_FLIGHTS
import net.sharetrip.flight.utils.ARG_FLIGHT_DETAILS_DATA
import net.sharetrip.flight.utils.ARG_FLIGHT_SEARCH
import net.sharetrip.flight.utils.ARG_FLIGHT_SEARCH_MODEL
import net.sharetrip.flight.utils.ARG_ITEM_FLIGHTS
...
class FlightDetailsFragment : BaseFragment<FragmentFlightDetailsBinding>() {
    ...
    /*companion object {
        @JvmField val ARG_FLIGHT_SEARCH_MODEL = "ARG_FLIGHT_SEARCH_MODEL"
        @JvmField val ARG_ITEM_FLIGHTS = "ARG_ITEM_FLIGHTS"
        @JvmField val ARG_RULES_DETAILS = "ARG_RULES_DETAILS"
        @JvmField val ARG_FLIGHT_DETAILS_DATA = "ARG_FLIGHT_DETAILS_DATA"
        @JvmField val ARG_FLIGHT_SEARCH = "ARG_FLIGHT_SEARCH"
        @JvmField val ARG_FLIGHTS = "ARG_FLIGHTS"
        @JvmField val ARG_DISCOUNT_MODEL = "ARG_DISCOUNT_MODEL"
        @JvmField val ARG_COUPON_RESPONSE = "ARG_COUPON_RESPONSE"
    }*/
}
