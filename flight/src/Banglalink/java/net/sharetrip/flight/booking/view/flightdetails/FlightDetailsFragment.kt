...
class FlightDetailsFragment : BaseFragment<FragmentFlightDetailsBinding>() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val accessToken = DataManager.getSharedPref(requireContext())[PrefKey.ACCESS_TOKEN, ""]
    ...
    override fun initOnCreateView() {
        ...
        viewModel.luggageResponse.observe(viewLifecycleOwner) { it ->
            ...
            if (it.wholeFlight && !it.isPerPerson) {
                ...
                baggageForPassengers(it.travellerBaggageList, it.isLuggageOptional)
    ...
    private fun baggageForPassengers(
