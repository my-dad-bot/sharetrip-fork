...
class FlightTrackerActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        navGraph.setStartDestination(when(intent.extras?.get(FLIGHT_TRACKER_ACTION) as FlightTrackerAction){
    ...
    companion object{
        ...
        fun openFlightTrackerActivity(context: Context, cls: Class<*>) {
            val intent = Intent(context, cls)
            intent.putExtra(FLIGHT_TRACKER_ACTION, Companion.FlightTrackerAction.TRIP_ADVISOR)
